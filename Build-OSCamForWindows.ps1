...
'@ | Out-File -FilePath (-join($tempPath,'\cygwin-portable-installer-config.cmd')) -Force -Encoding ascii
    ...
    $x = @'
        ...
        ./config.sh --enable WEBIF WEBIF_LIVELOG WEBIF_JQUERY WITH_SSL WITH_COMPRESS_WEBIF HAVE_DVBAPI WITH_EXTENDED_CW READ_SDT_CHARSETS CS_ANTICASC WITH_DEBUG MODULE_MONITOR WITH_LB CS_CACHEEX CS_CACHEEX_AIO CW_CYCLE_CHECK MODULE_CAMD33 MODULE_CAMD35 MODULE_CAMD35_TCP MODULE_NEWCAMD MODULE_CCCAM MODULE_CCCSHARE MODULE_GBOX MODULE_RADEGAST MODULE_SCAM MODULE_SERIAL MODULE_CONSTCW MODULE_PANDORA MODULE_GHTTP MODULE_STREAMRELAY READER_NAGRA READER_NAGRA_MERLIN READER_IRDETO READER_CONAX READER_CRYPTOWORKS READER_SECA READER_VIACCESS READER_VIDEOGUARD READER_DRE READER_TONGFANG READER_BULCRYPT READER_GRIFFIN READER_DGCRYPT CARDREADER_PHOENIX CARDREADER_SC8IN1 CARDREADER_MP35 CARDREADER_SMARGO CARDREADER_STINGER WITH_EMU WITH_SOFTCAM
